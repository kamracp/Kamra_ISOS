...
FACTORS = [
    ...
    EmissionFactorCreate(
        meter_type="carbon_anode",
        unit="kg",
        factor_kgco2e_per_unit=3.664,
        energy_content_gj_per_unit=None,
        region="IN",
        source="IPCC 2006 Guidelines Vol 3 Ch 4 (Metal Industry Emissions), Tier 1",
        source_year=2006,
        document_reference="Aluminium Hall-Heroult 2Al2O3+3C->4Al+3CO2; 44.01/12.011 ratio per kg net carbon consumed",
        valid_from=date(2006, 1, 1),
        valid_to=None,
        is_active=True,
        notes="Scope 1 PROCESS emission (Aluminium smelting), NOT fuel combustion. Per kg net carbon anode. energy_content None (no calorific value; excluded from SEC).",
    ),
    EmissionFactorCreate(
        meter_type="clinker_calcination",
        unit="kg",
        factor_kgco2e_per_unit=0.52,
        energy_content_gj_per_unit=None,
        region="IN",
        source="IPCC 2006 Guidelines Vol 3 Ch 2 (Mineral Industry Emissions), Tier 1",
        source_year=2006,
        document_reference="Cement clinker CaCO3->CaO+CO2; 0.5101 t/t (65% CaO + 0.4397 ratio + 2% CKD), rounded 0.52",
        valid_from=date(2006, 1, 1),
        valid_to=None,
        is_active=True,
        notes="Scope 1 PROCESS emission (Cement clinker), NOT fuel combustion. Per kg clinker. energy_content None (excluded from SEC).",
    ),
]
