...
from app.services.esg_report_service import generate_brsr_principle1, generate_brsr_principle6, generate_brsr_principle7, generate_brsr_principle8, generate_gri_305, generate_esrs_e1, generate_trend
